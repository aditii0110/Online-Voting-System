<%-- 
    Document   : index
    Created on : 08-Apr-2021, 16:49:34
    Author     : DELL
--%>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        ...
                        <h1  > <font color="white">Voting Statistics TPR</font></h1>
         ...
         <a valign="left" href="adminhome.jsp" class="btn btn-light">ADMIN HOME</a>
          <a valign="left" href="Statistics.jsp" class="btn btn-light">CR</a>
           <a valign="left" href="StatisticsEX.jsp" class="btn btn-light">EXECUTIVE</a>
                ...
                <div class="col-lg-6">
                    <h2><i ><font color="white">TRAINING AND REPRESENTATIVE</font></i></h2>
                 <div id =  "chart" > </div>
                  
<%
    Map<String, String> chartConfig = new HashMap<String, String>();
    chartConfig.put("caption", "Votes Obtained");
    chartConfig.put("subCaption", "for the post TPR ");
...
<%
    Map<String, Integer> dataValuePair = new HashMap<String, Integer>();
                ...
                try {
                                ...
                                String sql = "SELECT ID,COUNT(ID),post FROM manivoting GROUP BY ID having post= 'TPR'";
...
%>   
 <%=firstChart.render() %>               
                ...
                <div  class="col-md-4">
                    ...
                    <h3><font color="white">Post : TPR</font></h4>
